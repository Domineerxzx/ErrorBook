package com.domineer.triplebro.mistakebook.services;
...
import com.domineer.triplebro.mistakebook.handlers.LoginHandler;
import com.domineer.triplebro.mistakebook.handlers.RegisterHandler;
import com.domineer.triplebro.mistakebook.properties.ProjectProperties;
import com.domineer.triplebro.mistakebook.providers.HttpProvider;
import com.domineer.triplebro.mistakebook.utils.httpUtils.HttpUtils;
...
public class NetworkConnectionService extends Service {
    ...
    private void register(final Context context, final String phone_number, /*String request_code, */final String password, final String nickname, final ServiceConnection serviceConnection, final int userType) {
        final RegisterHandler registerHandler = new RegisterHandler(context, serviceConnection);
        long userInfo;
        MistakeBookDataBase mistakeBookDataBase = new MistakeBookDataBase(context);
        SQLiteDatabase writableDatabase = mistakeBookDataBase.getWritableDatabase();
