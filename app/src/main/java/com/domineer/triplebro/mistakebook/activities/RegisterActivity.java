...
import com.domineer.triplebro.mistakebook.controllers.RegisterController;
        ...
        switch (v.getId()) {
            ...
            /*case R.id.bt_request_code:
                ...
                if (phone_number.length() == 11) {
                    ...
                    registerController.getRequestCode(phone_number);
                } else {
            ...
            case R.id.bt_create:
                ...
                if (username.length() == 0) {
                    ...
                    registerController.register(phone_number,/* request_code,*/ password, username,userType);
                }
                break;
