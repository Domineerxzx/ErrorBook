...
public class ErrorListAdapter extends BaseAdapter {
    ...
    public ErrorListAdapter(Context context, List<ErrorInfo> errorInfoList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = View.inflate(context, R.layout.item_error_list,null);
        ...
        View.OnClickListener intent = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent errorInfo = new Intent(context, ErrorInfoActivity.class);
