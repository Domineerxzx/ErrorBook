...
import com.domineer.triplebro.mistakebook.activities.AboutUsActivity;
import com.domineer.triplebro.mistakebook.activities.CollectActivity;
import com.domineer.triplebro.mistakebook.activities.LoginActivity;
import com.domineer.triplebro.mistakebook.activities.SettingActivity;
...
public class MyselfFragment extends Fragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        SharedPreferences.Editor edit = userInfo.edit();
        MistakeBookDataBase myOpenHelper = new MistakeBookDataBase(getActivity());
